...
export async function GET() {
  ...
  return Response.json({
    ...
    annaRequests: listRequestsForStudent("00000000-0000-0000-0000-000000000001").map((r) => ({
      id: r.ua_requestid,
    ...
    tomRequests: listRequestsForStudent("00000000-0000-0000-0000-000000000002").map((r) => ({
      id: r.ua_requestid,
      filenumber: r.ua_filenumber,
    })),
  });
