  ...
  return (
    ...
    >
      ...
      <dl className="grid gap-3 text-small sm:grid-cols-2">
        <Row label="Naam" value={`${student.firstname ?? ""} ${student.lastname ?? ""}`.trim()} />
        <Row label="E-mail" value={student.emailaddress1} />
        ...
        <Row label="Rolnummer" value={student.ua_rollnumber} />
        <Row label="Domicilieadres" value={student.ua_domicileaddress} fullWidth />
        <Row label="Studentenverblijf" value={student.ua_registeredaddress} fullWidth />
      </dl>
